          ...
          <div class="row">
              <div class="col-lg-3 col-md-6 col-sm-8 order-2 order-lg-1 produts-sidebar-filter">
                  ...
                  <div >
                    ...
                    <input type="button" name="" value="Apply" class="btn btn-primary">
                  </div>
...
@section('script')
  ...
  $(document).ready(function(){
    ...
    for (var i = 0; i < categories.length; i++) {
      $("#"+removespace(JSON.parse(categories[0]).name)).prop("checked", true);
    }
    for (var i = 0; i < brands.length; i++) {
      $("#"+removespace(JSON.parse(brands[0]).name)).prop("checked", true);
      console.log(removespace("#"+JSON.parse(brands[0]).name));
    }
    for (var i = 0; i < types.length; i++) {
      $("#"+removespace(JSON.parse(types[0]).name)).prop("checked", true);
    }
  });
  </script>
@endsection
